DROP TABLE IF EXISTS employees.salary CASCADE;
DROP TABLE IF EXISTS employees.title CASCADE;
DROP TABLE IF EXISTS employees.department_employee CASCADE;
DROP TABLE IF EXISTS employees.department_manager CASCADE;
DROP TABLE IF EXISTS employees.employee CASCADE;
DROP TABLE IF EXISTS employees.department CASCADE;
...
EOSQLcat > db/init/01-dummy-data.sql << 'EOSQL'
DROP TABLE IF EXISTS employees.salary CASCADE;
DROP TABLE IF EXISTS employees.title CASCADE;
DROP TABLE IF EXISTS employees.department_employee CASCADE;
DROP TABLE IF EXISTS employees.department_manager CASCADE;
